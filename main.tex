...
\textsc{\LARGE TEKO Schweizerische Fachschule}\\[1.5cm] % Name of your university/college
\textsc{\Large Betriebswirtschaft, Prozess- und Qualitätsmanagement}\\[0.5cm] % Major heading such as course name
...
\\St. Galler Management-Modell
\\SBB Cargo AG}\\[0.4cm] % Title of your document
\HRule \\[1.5cm]
...
Dabei bieten sie zwei Hauptbereiche und einen Zusatzbereich an.
Einer der zwei Hauptbereiche sind die Transportangebote. Diese bestehen aus Wagenladungsverkehr, Ganzzüge, kombinierter Verkehr, Bau \& Baulogistik und Entsorgung \& Recycling ist.
% TODO: Evtl. ein Diagramm für die Übersicht 
Der zweite Hauptbereich sind die Rollmaterialangebote. Diese bestehen aus folgenden Teilen: Flottenmanagement \& Service, Instandhaltung SBB Cargo AG und Vermietung von Rollmaterialien. 
Der Bereich Zusatzleistungen wird aufgeteilt in bahnnahe Logistikleistungen und Services für Bahnunternehmen \parencite[o. S.]{angebot}.
...
Laut dem Geschäftsbericht 2022 hatte die SBB Cargo AG einen Verlust von 187.4 Millionen CHF.
...
Der Strom für den Antrieb der Züge wird grösstenteils von der SBB AG produziert.
...
Und PJ Messtechnik GmbH bietet Systemlösungen für den Schienenverkehr an, welche die SBB Cargo AG einsetzt \parencite[o. S.]{partnerPJMesstechnik}.
...
Hier schauen wir die verschiedenen Umweltsphären des St. Galler Management-Modells an.
...
Dies ist darauf zurückzuführen, dass das ganze Güternetz, welches betrieben wird, eine CO2 Ersparnis von 490 000 Tonnen pro Jahr einbringt \parencite[o. S.]{startseiteSbbCargoAG}.
% Quelle: https://www.sbbcargo.com/de/home.html

\item Umweltverschmutzung:
Eine der grössten Klimabelastungen sind die Fahrten von Diesellokomotiven auf Strecken, welche nicht elektrifiziert sind \parencite[o. S.]{umweltschutzKlima}.
% Quelle: https://www.sbbcargo.com/de/unternehmen/qualitaet-sicherheit-umwelt/umwelt/klima.html   
...
Die SBB AG sagt, dass sie aktuell mit 90\% Energie aus Wasserkraft fährt und 10\% Energie aus Atomstrom sind. Das Ziel der SBB AG ist, die 10\% Atomstrom mit Strom aus eigenen Anlagen oder aus Anlagen, welche unter Vertrag stehen, zu ersetzen \parencite[o. S.]{nachhaltigeEnergie}.
% Quelle: https://company.sbb.ch/de/sbb-als-geschaeftspartner/leistungen-evu/energie/nachhaltige-energie.html#:~:text=Das%20entspricht%20850%20Gigawattstunden%20Energie,Infrastrukturanlagen%20umfassende%20Energieeffizienz-Massnahmen%20um
...
Die Umleitung über die Panoramastrecke darf von Güterzügen nur sehr beschränkt eingesetzt werden \parencite[o. S.]{gotthardEntgleisungNews}.
% Quelle: https://news.sbb.ch/artikel/124161/entgleisung-im-gotthard-basistunnel-alles-was-sie-fuer-ihre-reise-wissen-muessen
...
\begin{figure}[htbp] % h bedeutet "here" und gibt an, dass das Bild hier eingefügt werden soll
    ...
    \caption{Gotthardtunnel Unfall} \parencite[o. S.]{gotthardtunnelBild}
    \label{fig:bildlabel}
\end{figure}
...
\begin{itemize}
    ...
    \item Cargo Check-in: Diese ist eine mobile App, welche dem Kunden ermöglicht, den Check-in-Prozess an der Rampe via Smartphone selbst vorzunehmen.
...
\begin{itemize}
    ...
    Dadurch sollen politische Massnahmen definiert werden, die den Güterverkehr nachhaltig von den Strassen auf die Schienen bringen soll \parencite[o. S.]{verlagerungspolitik}.
...
\begin{itemize}
    ...
    Dies bringt neue Kunden, jedoch auch neue Konkurrenten aus dem Ausland. 
\end{itemize}

\subsection{Anspruchsgruppen}

Jetzt folgen die Anspruchsgruppen des St. Galler Management-Modell.

\subsubsection{Kapitalgeber}
Die Finanzierung von der SBB Cargo AG ist durch die SBB AG sichergestellt, welche vom Bund finanziert wird.
...
\subsubsection{Staat}
Der Staat gibt die Rahmenbedingungen vor und hat die Erwartung, dass diese auch eingehalten und überwacht werden.
...
\subsection{Chancen}
\begin{itemize}
    \item Das Baseler Bauprojekt
    \item Die vielen neuen, technologischen Entwicklungen
    \item Die Verlagerungspolitik
    \item Die Globalisierung des Gütertransportes
\end{itemize}
\subsection{Gefahren}
\begin{itemize}
    \item Die Kunden, welche wegen des Unfalles im Gotthardtunnel auf den Strassenverkehr gewechselt haben, kommen nicht mehr zurück.
...
\begin{itemize}
    \item Abschluss des Baseler Bauprojektes nutzen. Dadurch kann in der Region eine grösserer Transportbedarf abgedeckt werden. 
...
\begin{itemize}
    ...
    \item Es besteht eine gute Möglichkeit, mehr Kunden für den Schienentransport zu gewinnen, da man den Gütertransport in diese Richtung drängt. 
...
\begin{itemize}
    ...
    \item Man muss ein attraktives Angebot bereitstellen, um die wechselnden Kunden nicht an anderen Transportunternehmen zu verlieren.
\end{itemize}
